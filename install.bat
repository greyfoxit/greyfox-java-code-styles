REM Installs Greyfox's IntelliJ configs into your user configs.
@echo off
echo Installing Greyfox IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Greyfox' or 'GreyfoxAndroid'.
exit /b
